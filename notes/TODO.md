...
3. **Static fields lie in distributed systems** *(2026-05-07)*
...
4. **The three logging blind spots that recur in every service** *(2026-05-08)*
...
5. **Stop calling all three things "agent": model-call, tool-orchestrator, goal-seeking loop** *(2026-05-14)*
